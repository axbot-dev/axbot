...
public class WTFunction {
    ...
    public static String profileFound(String nickname, WtGamerProfile profile) {
        ...
        f1.add(KookCardMessage.newKMarkdown(KookKMarkdownMessage.bold("昵称") + "\n" + profile.getNickname()));
        f1.add(KookCardMessage.newKMarkdown(KookKMarkdownMessage.bold("称号") + "\n" + profile.getTitle()));
        ...
        f2.add(KookCardMessage.newKMarkdown(KookKMarkdownMessage.bold("历史任务数") + "\n" + rb.getTotalMission()));
        f2.add(KookCardMessage.newKMarkdown(KookKMarkdownMessage.bold("历史胜率") + "\n" + NumberFormat.getPercentInstance().format(rb.getWinRate())));
        f2.add(KookCardMessage.newKMarkdown(KookKMarkdownMessage.bold("历史KD") + "\n" + df.format(rbKd)));
        ...
        f3.add(KookCardMessage.newKMarkdown(KookKMarkdownMessage.bold("空战历史KA") + "\n" + df.format(arbKa)));
        ...
        f3.add(KookCardMessage.newKMarkdown(KookKMarkdownMessage.bold("陆战历史KA") + "\n" + df.format(grbKa)));
        ...
        f3.add(KookCardMessage.newKMarkdown(KookKMarkdownMessage.bold("海战历史KA") + "\n" + df.format(frbKa)));
