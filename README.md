...
## 使用手册
如果您是一位普通用户，对于AXBot的使用方式和所具备的功能感到好奇，我们为您提供了使用手册，其中详尽列出了该机器人现已具备的全部功能及正在开发中的新功能。请随时点击以下文档链接查看。
...
除了官方维护的机器人外，还有以下社区维护的机器人存在：

- ~~并没有~~

## 部署指南

如果您希望自己部署和维护机器人，请点击下方的文档链接，详细阅读相关内容。
...
注意，自行部署机器人即代表你同意并遵循AXBot的开源协议规定的一切条款，这意味着：
...
AXBot并不是一个机器人框架，AXBot是一个已经实现了业务功能的机器人，如果你需要继续开发功能，请参考下文的开发指南
