...
<iframe id="afdian_leaflet_afdian" src="https://afdian.net/leaflet?slug=afdian" width="100%" scrolling="no" height="200" frameborder="0"></iframe><script>document.body.clientWidth< 700 ? document.getElementById("afdian_leaflet_afdian").width = "100%" : document.getElementById("afdian_leaflet_afdian").width = "640"</script>
