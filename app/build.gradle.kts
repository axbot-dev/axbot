...
dependencies {
    ...
    implementation("net.javacrumbs.shedlock:shedlock-provider-redis-spring:5.7.0")
    ...
    implementation("love.forte.simbot.component:simbot-component-kook-core:3.2.0.0-alpha.8-dev.4")
